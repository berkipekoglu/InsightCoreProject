...
class InsightCoreSDK {
    ...
    startRrwebRecording() {
        this.stopRecording = (0, rrweb_1.record)({
    ...
    captureWebVitals() {
        ...
        (0, web_vitals_1.onCLS)(metricHandler);
        (0, web_vitals_1.onFCP)(metricHandler);
        (0, web_vitals_1.onFID)(metricHandler);
        (0, web_vitals_1.onLCP)(metricHandler);
        (0, web_vitals_1.onTTFB)(metricHandler);
    }
    captureErrors() {
